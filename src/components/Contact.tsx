...
export function Contact() {
  ...
  return (
    <Section id="contact" maxWidth="max-w-3xl">
      <div className="text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[var(--color-accent)] px-6 py-2.5 text-sm font-medium text-white shadow-[0_0_20px_var(--color-accent)] transition-transform hover:scale-105"
          >
